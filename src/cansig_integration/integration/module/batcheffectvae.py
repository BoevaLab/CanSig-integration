...
from cansig_integration.integration.base.module import CanSigBaseModule  # pytype: disable=import-error
...
# VAECanSig model
class VAEBatchEffect(CanSigBaseModule):
    """
    ...
    def __init__(
        ...
        if self.dispersion == "gene":
            ...
            raise ValueError(
                "dispersion must be one of ['gene', 'gene-celltype',"
        ...
        cat_list = [n_celltype] + list([] if n_cats_per_cov is None else n_cats_per_cov)
    ...
    def _get_inference_input(self, tensors):
        ...
        input_dict = dict(x=x, batch_index=celltype, cont_covs=cont_covs, cat_covs=cat_covs)
        return input_dict
    ...
    def generative(
        ...
        if self.dispersion == "gene-label":
            ...
            px_r = F.linear(one_hot(batch_index, self.n_celltype), self.px_r)
    ...
    def loss(
        ...
        x = tensors[REGISTRY_KEYS.X_KEY]
        batch_index = tensors[REGISTRY_KEYS.CELLTYPE_KEY]
