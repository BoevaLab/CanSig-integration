...
from cansig_integration.integration._CONSTANTS import REGISTRY_KEYS  # pytype: disable=import-error
from cansig_integration.integration.base.model import RepresentationModel  # pytype: disable=import-error
from cansig_integration.integration.data.fields import CellTypeField  # pytype: disable=import-error
from cansig_integration.integration.module.batcheffectvae import VAEBatchEffect  # pytype: disable=import-error
from cansig_integration.integration.module.cnvvae import VAECNV  # pytype: disable=import-error
from cansig_integration.integration.module.vae import VAECanSig  # pytype: disable=import-error
from cansig_integration.integration.training.trainer import UnsupervisedTrainingCanSig  # pytype: disable=import-error


class CanSigIntegration(UnsupervisedTrainingCanSig, BaseModelClass, RepresentationModel):
    """
    ...
    def __init__(
        ...
        **model_kwargs,
        ...
        super(CanSigIntegration, self).__init__(adata)
