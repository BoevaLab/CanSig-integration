...
class DataSplitter(pl.LightningDataModule):
    ...
    **kwargs
    ...
    def setup(self, stage: Optional[str] = None):
        ...
        accelerator, lightning_devices, self.device = parse_use_gpu_arg(self.use_gpu, return_device=True)
        self.pin_memory = True if (settings.dl_pin_memory_gpu_training and accelerator != 0) else False
